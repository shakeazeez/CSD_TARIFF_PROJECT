    ...
    */
    function validateForm (form) {
        ...
        if (form.username == "" || form.password == "") {
            ...
            tempErrors.username = "Username should not contain spaces.";    

        } else if (!usernameValidChars.test(form.username)) {
            tempErrors.username = "Username should only contain alphabets, numbers, _ or .";
 
        } else if (form.password.length < 8 || form.password.length > 20) {
            tempErrors.password = "Password should be 8 - 20 characters long."; 

        } else if (!passwordValidChars.test(form.password)) {
            tempErrors.password = "Password should only contain alphabets, numbers, # or $."; 
        }
